declare module "svelte-popperjs" {
  import { Instance, OptionsGeneric, Modifier } from "@popperjs/core";
  export declare type PopperOptions<TModifier> =
    | Partial<OptionsGeneric<TModifier>>
    | undefined;
  export declare type ReferenceAction = (
    node: HTMLElement
  ) => {
    destroy(): void;
  };
  export declare type ContentAction<TModifier> = (
    node: HTMLElement,
  ...
  export declare function createPopperActions<
